...
function bst_enqueues()
{
  	...
  	wp_register_style('bst-css', get_template_directory_uri() . '/css/bst.css', false, null);
		...
		wp_register_style('media-css', get_template_directory_uri() . '/media.css', false, null);
		wp_enqueue_style('media-css');
		
		wp_register_style('animate-css', get_template_directory_uri() . '/css/animate.css', false, null);
		wp_enqueue_style('animate-css');
		
		wp_register_style('font-awesome-css', get_template_directory_uri() . '/css/fa/css/font-awesome.css', false, null);
    ...
    wp_enqueue_script('bst-js');
     ...
     wp_register_script('video-js', get_template_directory_uri() . '/js/video.js', false, null, true);
    wp_enqueue_script('video-js');
    
    wp_register_script('smooth-scroll-js', get_template_directory_uri() . '/js/smooth-scroll.js', false, null, true);
